...
//Begin Protoss Structures
    ...
    if (cmd ===`${prefix}forge`){
        ...
        .addField("Ground Armor Level 2", "**Requires:** Twilight Council, **Minerals** - 175, **Vespene** - 175, **Time** - 169, **Effect** - Increases the armor of Protoss ground units. ")
    ...
    if (cmd ===`${prefix}cyberneticscore`||cmd ===`${prefix}cybercore`||cmd ===`${prefix}cyber`){
        ...
        .addField("Air Weapons Level 1", "**Minerals** - 100, **Vespene** - 100, **Time** - 119, **Effect** - Increases the damage of Protoss air units.")
        ...
        .addField("Air Armor Level 1", "**Minerals** - 150, **Vespene** - 150, **Time** - 119, **Effect** - Increases the armor of Protoss air units units. ")
